...
export const ourTeamContent = [
  {
    ...
    description:
      <>
        ...
        <p>Kody has a MBA from the University of Calgary specializing in Global Energy Management and Sustainability, and is an accredited Certified Fraud Examiner.</p>
      </>
  },
  {
    image: codyAustin,
    ...
    description:
      <>
        ...
        <p>Cody has served as the President of the Petroleum Accountants Society of Canada (PASC) for 2 years (2015-2017) and due to his success in leading the restructuring of the society financials will be serving an unpresented third year in the Presidency. Cody has also served as a member the PASC board of directors and Education Committee developing technical training on topics such as PASC and AIPN agreements.</p>
        <p>Through his involvement in industry, Cody has attended multiple conferences and seminars as both an attendee and as speaker/panelist providing accounting and financial viewpoints to industry discussions. Cody has represented industry on several multiple stakeholder committees overseeing the developing and publishing key auditing and accounting framework. His competitive strength is the ability to connect business and accounting and offer practical solutions that match commercial needs.</p>
      </>
  },
  {
    image: chrisEverett,
  ...
  },
  {
    ...
    description:
      <>
        <p>Kevin is a specialist in joint venture and partnership audits. He has managed and worked on audits of all sizes, from audits of junior producers up to billion-dollar major projects. His experience includes auditing capital projects, operations and maintenance, final statements of adjustments (FSOA), vendor compliance, processing fees and fee income, equalizations, 13th month adjustments, and production allocations.</p>
        <p>As the former audit coordinator for a midsize producer, Kevin also has extensive experience with audit coordination, resolving audit exceptions and partner disputes, and identifying missed recoveries.</p>
